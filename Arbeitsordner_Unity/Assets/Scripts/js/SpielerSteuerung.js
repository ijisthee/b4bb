...
function FixedUpdate () {
	...
	if (directionVector != Vector2.zero) {
		gameObject.GetComponent(Rigidbody).AddForce(Vector3(Input.GetAxis("Horizontal") * GetComponent.<Rigidbody>().mass, Input.GetAxis("Vertical") * GetComponent.<Rigidbody>().mass));
	}
